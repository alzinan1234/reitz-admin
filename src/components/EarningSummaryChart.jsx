      ...
      <div className="w-full flex justify-between items-center">
        ...
        <div className="flex justify-center items-center gap-1">
          ...
          <div className="flex justify-center items-center gap-1 px-1.5 py-0.5 bg-[#4BB54B1A] rounded-3xl">
            {/* Changed SVG fill color to black */}
            ...
            {/* Changed text color to black */}
            <div className="text-black text-sm font-semibold font-['DM Sans']">9%</div>
          </div>
        </div>
      ...
      <div className="w-full h-56"> {/* Fixed height for the chart */}
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            {/* Changed grid line color to be lighter for white background */}
            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e0e0e0" />
            <XAxis
              dataKey="name"
              stroke="#ccc"
              // Changed tick fill color to black
            ...
            <Tooltip
              ...
              // Changed tooltip styles for readability on a white background
              contentStyle={{ background: 'white', border: '1px solid #ccc', borderRadius: '5px' }}
              labelStyle={{ color: 'black' }}
              itemStyle={{ color: '#96B4CA' }} // Updated to match gradient start color
