      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center ">
              ...
              {/* <button className=" transition-colors bg-[#303030] text-white p-[5px] rounded-tr-[7.04px] rounded-br-[7.04px] border-[1px] border-gray-300">
                <svg
        ...
        <div className="relative text-black flex flex-col justify-center items-center mb-6">
          ...
          <button
            ...
            className="flex items-center gap-[8.31px] w-[73px] mb-5 h-[27px] pl-[6.65px] rounded-[18.28px] bg-[#4B697F] border border-gray-300 text-white"
          >
